...
Marking Bills as Paid
    ...
    Go to Dashboard or Bills view
    Find the bill
    Tap "✓ Paid" if paid on time
    Tap "⏰ Late" if paid late

Viewing History

    Tap the "📈" (History) button
    View your health score trend
    See all payment history with status
...
Primary: Teal Green (#14b8a6) Success: Green (#10b981) Danger: Red (#ef4444) Warning: Orange (#f59e0b)
License
